...
"--num_epochs 3", "--freeze-bert --num_epochs 3", "--lr 1e-6 --num_epochs 3", "--lr 5e-5 --num_epochs 3", "--freeze-bert --lr 1e-4 --num_epochs 3", "--freeze-bert --lr 1e-5 --num_epochs 3",
"--freeze-bert --lr 5e-5 --num_epochs 3")
